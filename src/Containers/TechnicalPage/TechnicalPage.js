  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.skills}>
        ...
        <div
          className={[
            classes.skills_section,
            classes.skills_section___backEnd,
          ].join(' ')}
        >
          <h2>Back End</h2>
          <img
        ...
        <div
          className={[
            classes.skills_section,
            classes.skills_section___tools,
          ].join(' ')}
        >
          <h2>Tools</h2>
          <img
      ...
      <div className={classes.education}>
        ...
        <p className={classes.para}>
          After my early education I completed a BA-hons degree in furniture and
          industrial design. During my re-training in web development alongside
          many (many) courses and sources of information I have completed
          several certificates so far:
        </p>
