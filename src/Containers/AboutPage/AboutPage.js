    ...
    <div>
      ...
      <div className={[classes.section, classes.section___dark].join(' ')}>
        <div className={classes.section_paragraph}>
          ...
          <p>
            ...
            do) and the drive to build and create never left me.
          </p>
          <p>
            My path to becoming a web developer is roundabout as I started with
            a 9 year career as an industrial designer. After a BA degree in
            furniture and product design, that part of my story is long and
            contains all kinds of things like moving to Canada and starting a
            furniture company with my father. It wasnt until I was around 30
      ...
      <div className={classes.section}>
        <div className={classes.section_paragraph}>
          ...
          <p>Sorry about the cheesy header, I couldnt resist!</p>
          <p>
            A friend of mine introduced me to the world of code via a few basic
            tutorials, when he was going through a bootcamp, he knew me well and
            thought that I might enjoy it.
          </p>
          <p>
            Turns out he was right, I got hooked. For a few years I hobbie coded
            doing a lot of intro courses in several areas and languages
          ...
          <p>
            I went gained several certficationas and built my knoladge bit by
            bit. Working with mentors, local meetup groups and friends has
