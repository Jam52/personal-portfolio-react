      ...
      <div className={classes.section}>
        <div className={classes.section_paragraph}>
          ...
          <p>
            ...
            and industrial design, emigrating to Canada and starting a furniture
            business with my father. It wasn’t until I was around 30 that my
      ...
      <div className={classes.section}>
        <div className={classes.section_paragraph}>
          ...
          <p>
            ...
            seriously I decided to take the plunge. I left my industrial design
            career to study web development and pursue a new career while
            looking after my young daughter.
          </p>
          <p>
